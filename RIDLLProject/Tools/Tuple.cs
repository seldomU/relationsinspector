// smooth foundations tuples. MIT licensed
...
namespace RelationsInspector.Smooth.Collections
{
	/// <summary>
	...
	public abstract class EqualityComparer<T> : IEqualityComparer<T>
	{
		...
		public static IEqualityComparer<T> Default
		{
			get
			{
				if ( _default == null )
				{
					_default = System.Collections.Generic.EqualityComparer<T>.Default;
				}
				return _default;
			}
			set { _default = value; }
	...
	public abstract class Comparer<T> : IComparer<T>
	{
		...
		public static IComparer<T> Default
		{
			get
			{
				if ( _default == null )
				{
					_default = System.Collections.Generic.Comparer<T>.Default;
				}
				return _default;
			}
			set { _default = value; }
