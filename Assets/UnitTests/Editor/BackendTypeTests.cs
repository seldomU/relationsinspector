...
namespace Assets.UnitTests.Editor
{
    ...
    class BackendTypeTests
    {
        ...
        class V2Backend : IGraphBackend2<string, string>
        {
            ...
            public IEnumerable<Tuple<string, string>> GetRelated(string entity) { yield break; }
            public IEnumerable<Tuple<string, string>> GetRelating(string entity) { yield break; }
